...
function StopWatch() {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className=" flex flex-col justify-center items-center bg-circleRed bg-cover bg-no-repeat bg-center h-60 w-60 my-10 sm:h-80 sm:w-80 sm:my-4  static z-1 drop-shadow-md">
